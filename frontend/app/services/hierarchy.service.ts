  ...
  export class HierarchyService {
    ...
    getHierarchy(zhId) {
      this._dataService.getHierZh(zhId).subscribe(
        ...
        (error) => {
          if (error.error.message == 'wrong_qualif') {
    ...
    setItems(data) {
      ...
      // cat 1
      this.items.push({"name": data.volet1.cat1_sdage.name.toUpperCase( ), "active":true, "qualification":"", "knowledge": "", "note": ""})
      this.bold_row_values.push(data.volet1.cat1_sdage.name.toUpperCase( ))
      this.items.push(data.volet1.cat1_sdage.items[0]);
      this.items.push({"name": "Total rubrique", "active":true, "qualification":"", "knowledge": "", "note": data.volet1.cat1_sdage.note})

      this.items.push({"name": "", "active":true, "qualification":"", "knowledge": "", "note": ""})

      // cat 2
      this.items.push({"name": data.volet1.cat2_heritage.name.toUpperCase( ), "active":true, "qualification":"", "knowledge": "", "note": ""})
      ...
      this.items.push({"name": "Total rubrique", "active":true, "qualification":"", "knowledge": "", "note": data.volet1.cat2_heritage.note})

      this.items.push({"name": "", "active":true, "qualification":"", "knowledge": "", "note": ""})

      // cat 3
      this.items.push({"name": data.volet1.cat3_eco.name.toUpperCase( ), "active":true, "qualification":"", "knowledge": "", "note": ""})
      this.bold_row_values.push(data.volet1.cat3_eco.name.toUpperCase( ))
      this.items.push(data.volet1.cat3_eco.items[0]);
      this.items.push({"name": "Total rubrique", "active":true, "qualification":"", "knowledge": "", "note": data.volet1.cat3_eco.note})

      this.items.push({"name": "", "active":true, "qualification":"", "knowledge": "", "note": ""})

      // cat 4
      this.items.push({"name": data.volet1.cat4_hydro.name.toUpperCase( ), "active":true, "qualification":"", "knowledge": "", "note": ""})
      ...
      this.items.push({"name": "Total rubrique", "active":true, "qualification":"", "knowledge": "", "note": data.volet1.cat4_hydro.note})

      this.items.push({"name": "", "active":true, "qualification":"", "knowledge": "", "note": ""})

      // cat 5
      this.items.push({"name": data.volet1.cat5_soc_eco.name.toUpperCase( ), "active":true, "qualification":"", "knowledge": "", "note": ""})
      ...
      this.items.push({"name": "Total rubrique", "active":true, "qualification":"", "knowledge": "", "note": data.volet1.cat5_soc_eco.note})

      this.items.push({"name": "", "active":true, "qualification":"", "knowledge": "", "note": ""})

      // note volet 1
      this.items.push({"name": "NOTE VOLET 1 - VALEUR GLOBALE", "active":true, "qualification":"", "knowledge": "", "note": data.volet1.note})
      this.bold_row_values.push("NOTE VOLET 1 - VALEUR GLOBALE")
      this.items.push({"name": "", "active":true, "qualification":"", "knowledge": "", "note": ""})

      // cat 6
      this.items.push({"name": data.volet2.cat6_status.name.toUpperCase( ), "active":true, "qualification":"", "knowledge": "", "note": ""})
      ...
      this.items.push({"name": "Total rubrique", "active":true, "qualification":"", "knowledge": "", "note": data.volet2.cat6_status.note})

      this.items.push({"name": "", "active":true, "qualification":"", "knowledge": "", "note": ""})

      // cat 7
      this.items.push({"name": data.volet2.cat7_fct_state.name.toUpperCase( ), "active":true, "qualification":"", "knowledge": "", "note": ""})
      ...
      this.items.push({"name": "Total rubrique", "active":true, "qualification":"", "knowledge": "", "note": data.volet2.cat7_fct_state.note})

      this.items.push({"name": "", "active":true, "qualification":"", "knowledge": "", "note": ""})

      // cat 8
      this.items.push({"name": data.volet2.cat8_thread.name.toUpperCase( ), "active":true, "qualification":"", "knowledge": "", "note": ""})
      this.bold_row_values.push(data.volet2.cat8_thread.name.toUpperCase( ))
      this.items.push(data.volet2.cat8_thread.items[0]);
      this.items.push({"name": "Total rubrique", "active":true, "qualification":"", "knowledge": "", "note": data.volet2.cat8_thread.note})

      this.items.push({"name": "", "active":true, "qualification":"", "knowledge": "", "note": ""})

      // note volet 2 - priorite d'intervention
      this.items.push({"name": "NOTE VOLET 2 - PRIORITE D'INTERVENTION", "active":true, "qualification":"", "knowledge": "", "note": data.volet2.note})
      this.bold_row_values.push("NOTE VOLET 2 - PRIORITE D'INTERVENTION")

      this.items.push({"name": "", "active":true, "qualification":"", "knowledge": "", "note": ""})

      // note globale
      this.items.push({"name": "TOTAL", "active":true, "qualification":"", "knowledge": "", "note": data.global_note})
      this.bold_row_values.push("TOTAL")

      // note globale
      this.items.push({"name": "NOTE FINALE", "active":true, "qualification":"", "knowledge": "", "note": data.final_note})
